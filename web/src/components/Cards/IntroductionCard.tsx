...
const IntroductionCard = ({
  ...
  return (
    <VStack
      ...
      {...props}
    >
      <div className="font-medium text-[30px] leading-[30px] z-[101]">
        {title}
      </div>
      <div className="max-w-[334px] font-nomal text-[14px] leading-[24px] text-[#898989] mt-[8px] z-[101]">
        {description}
      </div>
      {cardType === "coming-soon" && (
        <ComingSoonButton mt={"auto"} zIndex={101} />
      )}
      {cardType === "get-in-touch-team" && (
        <GetInTouchTeamButton
