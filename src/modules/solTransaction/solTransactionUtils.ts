import { ComputeBudgetProgram, Connection, PublicKey, Signer, Transaction, TransactionInstruction, TransactionMessage, VersionedTransaction } from '@solana/web3.js'
...
export async function createTransactionForInstructions({
  ...
  console.log(
    'Debug log for Solana transaction:',
    `Wallet: ${wallet}`,
    `Instructions count: ${transaction.instructions.length}`
  )
